import sbol3
'''
This file creates a .nt sbol file which contains a backbone without subcomponents 
'''
...
# --------------------------------------------------
doc.write('backbone_without_subcomponents_case.nt', sbol3.SORTED_NTRIPLES)
