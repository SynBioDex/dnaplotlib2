...
## First Backbone
##############################################################
b1_part1 = Part('Promoter1',1,'SO:2253254236',"Omar's Promoter")
b1_part1_dict = b1_part1.part_di()
# print(part1_dic)

b1_part2 = Part('Promoter2',1,'SO:432436',"Tom's Promoter")
b1_part2_dict = b1_part2.part_di()

b1_part3 = Part('RDS',1,'SO:923659328567',"Ahmed's RBS")
b1_part3_dict = b1_part3.part_di()
# print(part3_dict)

b1_part4 = Part('CDS',1,'SO:87265923869328567',"James's CDS")
b1_part4_dict = b1_part4.part_di()

b1_part5 = Part('Terminator',1,'SO:87265923869328567',"Tom's Terminator")
b1_part5_dict = b1_part5.part_di()

backbone1 = Backbone(name="Backbone 1")
...
## Second Backbone
############################################################ 
b2_part1 = Part('b2_Promoter1',1,'SO:2253254236',"Omar's Promoter")
b2_part1_dict = b2_part1.part_di()
# print(part1_dic)

b2_part2 = Part('b2_Promoter2',1,'SO:432436',"Tom's Promoter")
b2_part2_dict = b2_part2.part_di()

b2_part3 = Part('b2_RDS',1,'SO:923659328567',"Ahmed's RBS")
b2_part3_dict = b2_part3.part_di()
# print(part3_dict)

b2_part4 = Part('b2_CDS',1,'SO:87265923869328567',"James's CDS")
b2_part4_dict = b2_part4.part_di()

b2_part5 = Part('b2_Terminator',1,'SO:87265923869328567',"Tom's Terminator")
b2_part5_dict = b2_part5.part_di()

backbone2 = Backbone(name="Backbone 2")
...
mo2 = MolecularSpecies('macromolecule', 'SO:234455396', 'Second Molecule')
...
########################################
inter1 = Interaction('control', 'b2_RBS', 'b1_CDS', 'first interaction')
inter1.interaction_append()

inter2 = Interaction('control', 'b1_CDS', 'node1' , 'second interaction')
inter2.interaction_append()

inter3 = Interaction('control', 'mo2', 'node1' , 'third interaction')
inter3.interaction_append()

inter4 = Interaction('control', 'node1', 'mo1' , 'forth interaction')
